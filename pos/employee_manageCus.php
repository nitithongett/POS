                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td scope="col" style="text-align: center"><?php echo $row['phone']; ?></td>
                                                        <td scope="col" style="text-align: center"><?php echo $row['email']; ?></td>
                                                        <td scope="col" style="text-align: center"><?php echo $row['birthday']; ?></td>
                                                        <td><a href="employee_edit_Cus.php?update_id=<?php echo $row['id']; ?>" class="btn btn-sm btn-primary">Edit</a></td>
